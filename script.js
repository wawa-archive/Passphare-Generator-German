...
const germanWords = [
    ...
    "Durchschnitt","Durst","Dusche","Dutzend","Dynamik","Ebbe","Ebene","Echo","Echse","Ecke","Edelstein","Efeu","Effekt",
    ...
    "Etappe","Ethik","Etikett","Eule","Euro","Europa","Examen","Exemplar","Existenz","Export","Extra","Fabrik","Facette",
    "Fach","Fackel","Faden","Fähigkeit","Fahne","Fahrer","Fahrrad","Fahrt","Fahrzeug","Fakultät","Falke","Fall","Falle",
    ...
    "Fundament","Funke","Funktion","Furcht","Furche","Fusion","Fuss","Futter","Gabel","Galerie","Galle","Gang","Gans",
    ...
    "Gruß","Gummi","Gunst","Gurt","Guss","Gut","Gymnasium","Haar","Habe","Habicht","Hafen","Hafer","Haft","Hagel",
    ...
    "Hut","Hütte","Hyäne","Hydrant","Hygiene","Hymne","Hypnose","Hypothese","Ideal","Idee","Identität","Idiot","Idol",
    ...
    "Intrige","Intuition","Invasion","Inventar","Investition","Investor","Ironie","Irrtum","Isolation","Jacke","Jagd",
    "Jäger","Jahr","Jahrzehnt","Jänner","Januar","Japaner","Jargon","Jazz","Jeans","Joch","Jod","Joghurt","Journal",
    "Jubel","Jubiläum","Jude","Jugend","Juli","Juni","Jura","Jury","Justiz","Juwel","Kabine","Kabel","Kabarett",
    ...
    "Kürbis","Kurs","Kurve","Küste","Kutsche","Kuvert","Labor","Labyrinth","Lachs","Lack","Laden","Lage","Lager",
            ...
            "Münze","Museum","Musik","Muskel","Muster","Mut","Mutter","Mysterium","Mythos","Nachbar","Nachfrage","Nachlass",
            ...
            "Null","Nummer","Nuss","Nutzen","Nylon","Oase","Obdach","Obelisk","Oberst","Objekt","Obst","Ochse","Ofen",
            ...
            "Orient","Original","Orkan","Ort","Osten","Ozean","Ozon","Paar","Pacht","Packung","Pädagoge","Paket","Pakt",
            ...
            "Pyramide","Quadrat","Qual","Qualität","Qualle","Quantität","Quartett","Quartier","Quarz","Quaste","Quecksilber",
            "Quelle","Querschnitt","Quittung","Quote","Rache","Rad","Radar","Radierer","Radio","Radius","Rahmen","Rakete",
            ...
            "Rüssel","Rüstung","Rute","Rutsche","Saal","Saat","Säbel","Sack","Saft","Sage","Säge","Sahne","Saison","Saite",
            ...
            "Sympathie","Symptom","Synagoge","Syndikat","Syntax","Synthese","System","Szene","Tabak","Tabelle","Tablette",
            ...
            "Tumult","Tunnel","Tür","Turbine","Turm","Turnier","Typ","Tyrann","U-Bahn","U-Boot","Übel","Uberfall","Ufer",
            ...
            "Vorstoß","Vorteil","Vortrag","Vorurteil","Vorwand","Vorwort","Vorwurf","Vulkan","Waage","Wachs","Wachtel",
            ...
            "Wrack","Wunde","Wunder","Wunsch","Würde","Wurf","Würfel","Wurst","Wüste","Wut","Yacht","Yard","Yoga","Zahl",
            ...
            "Zweig","Zwerg","Zwiebel","Zwilling","Zwist","Zyklus","Zylinder"
];
